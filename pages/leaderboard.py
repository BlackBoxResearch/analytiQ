...
def leaderboard_page():
    ...
    with col1:
        with tile("competition_countdown", 40, True):
            ...
            countdown_html = f"""
            <div style="height: 50px; display: flex; align-items: flex-start; justify-content: flex-start; font-size: 20px; font-family: 'Source Sans Pro', sans-serif; color: #E8E8E8; background-color: #201c1c; border-radius: 5px; padding: 5px;">
